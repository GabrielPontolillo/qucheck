...
class NotSeparablePrecondition(Property):
    # specify the inputs that are to be generated
    def get_input_generators(self):
        return [RandomState(2)]
    ...
    def operations(self, mock):
        ...
        qc.h(0)
        qc.cx(0, 1)
        self.statistical_analysis.assert_separable(self, [0, 1], qc)
...
class SeparableCheckOnUnentangledState(Property):
    # specify the inputs that are to be generated
    def get_input_generators(self):
        # The assumption of our code is that we need at least one input generator, if we do not include it,
        # the code breaks in the test runner - also its a fine assumption to include, property based testing requires inputs
...
class SeparableCheckOnGHZState(Property):
    # specify the inputs that are to be generated
    def get_input_generators(self):
        # The assumption of our code is that we need at least one input generator, if we do not include it,
        # the code breaks in the test runner - also its a fine assumption to include, property based testing requires inputs
    ...
    def operations(self, mock):
        ...
        qc.cx(0, 1)
        qc.cx(1, 2)
        self.statistical_analysis.assert_separable(self, [0, 1, 2], qc, basis=["z"])
