...
from qucheck.case_studies.quantum_fourier_transform.linear_shift_induces_phase_shift_property import LinearShiftToPhaseShift
from qucheck.case_studies.quantum_fourier_transform.phase_shift_induces_linear_shift_property import PhaseShiftToLinearShift
