...
class TestDeutschJozsa(unittest.TestCase):
    def test_balanced_properties(self):
        # run the test
        runner = TestRunner([DeutschJozsaWorksForBalancedFunction], 5, 42, 1000)
        runner.run_tests()
    ...
    def test_constant_properties(self):
        # run the test
        runner = TestRunner([DeutschJozsaWorksForConstantFunction], 5, 4,  1000)
        runner.run_tests()
        # the property should pass
        assert runner.list_failing_properties() == []
    ...
    def test_vmerge_two_constant_oracles(self):
        # run the test
        runner = TestRunner([DeutschJozsaVMergeTwoConstantOracles], 5, 3, 1000)
        runner.run_tests()
        # the property should pass
        assert runner.list_failing_properties() == []
    ...
    def test_vmerge_two_balanced_oracles(self):
        # run the test
        runner = TestRunner([DeutschJozsaVMergeTwoBalancedOracles], 5, 2, 1000)
        runner.run_tests()
        # the property should pass
        assert runner.list_failing_properties() == []
    ...
    def test_lower_register_minus(self):
        # run the test
        runner = TestRunner([DeutschJozsaLowerRegisterMinus], 5, 11, 1000)
        runner.run_tests()
        # the property should pass
        assert runner.list_failing_properties() == []
